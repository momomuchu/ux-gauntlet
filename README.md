...
| Specification (`docs/specs/0001-ux-gauntlet-mvp.spec.md`) | written + disjoint-reviewed + unknowns-integrated + challenge-round-7-consolidated (205 requirements — F78/F79 deduped into the DR-09 patience family, F197/F198 added; count flat) — freeze-READY, awaiting founder approval, freeze withheld |
| RED acceptance test (`test/acceptance.test.mjs`) | in place, intentionally failing (83 tests, 0 pass, 83 fail) |
